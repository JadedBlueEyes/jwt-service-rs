...
mod tests {
    ...
    /// Test that demonstrates ONE client can be reused for MULTIPLE servers.
    /// This is the key benefit of using a custom DNS resolver.
    #[tokio::test]
    async fn test_client_reuse() {
        ...
        for server_name in servers {
            ...
            // Use the SAME client for this request
            let url = format!("{}/_matrix/federation/v1/version", resolution.base_url());
